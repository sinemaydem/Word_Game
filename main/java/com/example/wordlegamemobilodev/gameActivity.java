...
public class gameActivity extends AppCompatActivity {
    ...
    int control2=0;
    int control3=0;
    ArrayList <Integer> oldValuesOfNumber= new ArrayList<>();
    ArrayList <Integer> oldValuesOfNumber2= new ArrayList<>();
    ArrayList <Integer> oldValuesOfNumber3= new ArrayList<>();
    float startTime, finishTime, totalTime = (float) 0.0,totalTime1 = (float) 0.0,totalTime3 = (float) 0.0;
    String[] level1Words = {"TAS", "SAT", "KAR", "ARK", "MİS", "SİM", "ZAN", "NAZ", "İLK", "KİL", "KAS", "SAK"};
    String[] level2Words = {"MARS", "ARS", "SAM", "KAYA", "YAKA", "AYAK", "MAYA", "YAMA", "AYA", "SIRA", "SARI", "ASIR", "SIR", "SAAT", "ATA", "TASA", "ASA", "RANA", "ANA", "NAR"};
    String[] level3Words = {"SALAM", "MASAL", "AMA", "SAL", "ASAL", "KİTAP", "PATİK", "İKTA", "KAT", "ESANS", "SEN", "ANS", "ESAS", "SEANS", "KATIR", "ARTIK", "ATIK", "KIT", "KEFİR", "REFİK", "EFİR", "ERK", "KALEM", "EMLAK", "AMEL", "KEL"};
    ...
    public int chance=0,levelCounter=1,score=0,score1=0,score3=0;
    ...
    public void clickPauseIcon(View v){
        ...
        builder.setMessage("Ayrılmak istediğine emin misin");
        builder.setPositiveButton("Duraklat", (dialogInterface, i) -> {
        ...
        builder.setNegativeButton("Evet bitir", (dialogInterface, i) -> {
    ...
    public void call(){
        if(getLevelCounter()<19) {
            ...
            if(1<=getLevelCounter() && getLevelCounter()<=6 && thatsOkay(oldValuesOfNumber))
                onCreateSettings();
            else if(7<=getLevelCounter() && getLevelCounter()<=12 && thatsOkay(oldValuesOfNumber2))
                onCreateSettings();
            else if(13<=getLevelCounter() && getLevelCounter()<=18 && thatsOkay(oldValuesOfNumber3))
                onCreateSettings();
        }
        else {
            setFinishTime(System.nanoTime());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference myref = FirebaseDatabase.getInstance().getReference("Kullanicilar").child(currentUser.getUid());
        call();
        backbutton.setOnClickListener(view -> gameWord.setText(""));
    ...
    public void setLetterOfLevel1Game5(){
        activeLevel1Letters(lettersArray);
        lettersArray[0].setText("İ");
        lettersArray[4].setText("K");
        lettersArray[3].setText("L");

        String[] look={"7","8","9","14","20"};
        String[] let={"K"," İ","L"," İ","L","K"};
        generalSettings(look,let);
    }
    ...
    public void setLetterOfLevel3Game1() {
        lettersArray[0].setText("S");
        lettersArray[1].setText("M");
        lettersArray[2].setText("A");
        lettersArray[3].setText("L");
        lettersArray[4].setText("A");
    ...
    public void setLetterOfLevel3Game2() {
        lettersArray[0].setText("P");
        lettersArray[1].setText("İ");
        lettersArray[2].setText("K");
        lettersArray[3].setText("A");
        lettersArray[4].setText("T");
        activeLevel3Letters(lettersArray);
    ...
    public void setLetterOfLevel3Game3() {
        lettersArray[0].setText("E");
        lettersArray[1].setText("N");
        lettersArray[2].setText("S");
        lettersArray[3].setText("A");
        lettersArray[4].setText("S");
        activeLevel3Letters(lettersArray);
        String[] look={"0","1","2","3","4","7","10","12","13","14","16","22","25","26","27","28"};
    ...
    public void setLetterOfLevel3Game4() {
        lettersArray[0].setText("R");
        lettersArray[1].setText("I");
        lettersArray[2].setText("T");
        lettersArray[3].setText("K");
        lettersArray[4].setText("A");
    ...
    public void setLetterOfLevel3Game5() {
        lettersArray[0].setText("R");
        lettersArray[1].setText("F");
        lettersArray[2].setText("İ");
        lettersArray[3].setText("E");
        lettersArray[4].setText("K");
        activeLevel3Letters(lettersArray);
        String[] look={"0","1","2","3","4","7","10","13","16","18","19","20","22","28"};
    ...
    public void setLetterOfLevel3Game6(){
        lettersArray[0].setText("E");
        lettersArray[1].setText("K");
        lettersArray[2].setText("A");
        lettersArray[3].setText("M");
        lettersArray[4].setText("L");
        activeLevel3Letters(lettersArray);
        String[] look={"4","6","7","8","9","10","13","16","18","19","20","22","25","28"};
